...
namespace SinGooCMS.Utility
{
    ...
    public class ChinaDate
    {
        ...
        /// 获取农历
        /// </summary>
        public static CNDate GetChinaDate(DateTime? dtPara = null)
        {
            var dt = dtPara ?? DateTime.Now;
    ...
    public class ChineseCalendar
    {
        ...
        /// 用一个标准的公历日期来初使化
        /// </summary>
        public ChineseCalendar(DateTime? dtParam = null)
        {
            var dt = dtParam ?? DateTime.Now;
