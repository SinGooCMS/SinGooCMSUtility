...
namespace SinGooCMS.Utility
{
    ...
    public static class HexUtils
    {
        ...
        /// <returns></returns>
        public static unsafe string ToHex(string txt) =>
            ToHex(Encoding.UTF8.GetBytes(txt));

        /// <summary>
        /// 将给定的<seealso cref="T:byte[]"/>转换成16进制字符串
        /// </summary>
        ...
        /// 16进制转普通文本
        /// </summary>
        /// <param name="hexadecimalInput"></param>
        /// <returns></returns>
        public static unsafe string GetStrFromHex(string hexadecimalInput) =>
            Encoding.UTF8.GetString(FromHex(hexadecimalInput));

        /// <summary>
        /// 将给定的16进制字符串转为 <see cref="T:byte[]"/>.
        /// </summary>
